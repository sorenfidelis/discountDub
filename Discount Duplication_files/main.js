...
jQuery(function($){
  ...
  $('#pageheader .nav ul li.has-children ul a').attr('aria-haspopup', 'false');
  ...
  $('.product-photos').on('click', '.thumbnails .thumb', function(e){
    ...
    if($imgToChange.fadeToAnotherImage($(this).data('display-url'))) {
      $photoCont.find('.main a').attr('href', $(this).attr('href'));
